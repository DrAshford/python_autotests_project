...
class ProductPage(BasePage):
    ...
    def should_be_added_product_name(self):
        assert self.get_product_name() == self.get_added_product(), 'Added product name wrong!'

    def should_be_added_product_cost(self):
        assert self.get_product_cost() == self.get_basket_total(), 'Added product cost wrong!'
